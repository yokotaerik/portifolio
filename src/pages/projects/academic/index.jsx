...
Apesar de todas as dificuldades, tais desfios além das hardskills desenvolvidas ao tentar consertar o projeto e pensar um soluções rapidas para implementação das features faltantes,me ensinaram a importância da comunicação e organização de um projeto, que me fazem enxegar que uma equipe enxuta e eficiente é mais produtiva do que uma equipe grande com diversos problemas, além de uma conversa
que o professor responsável por avaliar a metodologia agil do projeto, que elucidou o que é realmente devemos fazer para alcançar um bom resultado, é necessário que a equipe inteira trabalhe para desenvolver o melhor produto possível, ajudando uns aos outros independente do papel no projeto, para assim conseguir alcançar uma equipe agíl.`, 
      stacks: [
